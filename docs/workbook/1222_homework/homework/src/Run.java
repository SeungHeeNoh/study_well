...
public class Run {
	public static void main(String[] args) throws Exception {
		...
		List<SweetPotato> sweetPotatoBox1 = sweetPotatoController.filterByType("밤고구마");
		List<SweetPotato> sweetPotatoBox2 = sweetPotatoController.filterGreaterThan(500);
		List<SweetPotato> sweetPotatoBox3 = sweetPotatoController.filterByLessThan(200);
		List<SweetPotato> sweetPotatoBox4 = sweetPotatoController.filterGreaterThanAndType(500, "호박고구마");
